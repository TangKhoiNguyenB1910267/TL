                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="registration/user" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="First Name" type="text" class="form-control form-control-user" id="exampleFirstName"
                                    ...
                                    <div class="col-sm-6">
                                        <input name="Last Name" type="text" class="form-control form-control-user" id="exampleLastName"
